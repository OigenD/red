...
#--- Этап 6: Назначение прав группе sonarqube-audit на все проекты ---
def assign_audit_permissions():
    print("=== Этап 6: Назначение прав группе sonarqube-audit на все проекты ===")

    # Константа для группы sonarqube-audit
    AUDIT_GROUP = "sonarqube-audit"
...
def main():
    ...
    stages = [
        ...
        ("Этап 6: Назначение прав группе ib_audit", assign_audit_permissions)
    ]
